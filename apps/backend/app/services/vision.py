    ...
    "properties": {
        ...
        "concepto": {
            ...
            "description": (
                ...
                "ubicarlo. Formato real tipico: el valor referencia la factura con "
                "su tipo y numero, separados por espacio o por guion, ej. 'Concepto  "
                "Factura FEI 152754' o 'Concepto  FEI-152754'. Transcribi en concepto el texto completo tal cual (con la palabra "
                "'Factura' u otras palabras incluidas si estan, no solo el codigo "
                "aislado), respetando el espacio o guion impreso. "
                "Cadena vacia si "
...
_EXTRACTION_PROMPT = (
    ...
    "cual en concepto. Formato real tipico: el valor referencia la factura "
    "con su tipo y numero, separados por espacio o por guion, ej. 'Concepto  "
    "Factura FEI 152754' o 'Concepto  FEI-152754'. Transcribi en concepto el texto "
    "completo tal cual (con la palabra 'Factura' u otras palabras incluidas "
    "si estan, no solo el codigo aislado), respetando el espacio o guion "
    "impreso. Ese bloque esta tipicamente "
