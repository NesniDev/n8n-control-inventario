    ...
    "properties": {
        ...
        "concepto": {
            ...
            "description": (
                ...
                "app.services.duplicates). En muchas guias de traslado ese numero NO "
                "esta en un campo con titulo: aparece debajo del NIT, junto al nombre "
                "de la persona que transporta la mercaderia -- si ves ahi un codigo "
                "tipo-numero (ej. 'FEI-12345'), incluilo en concepto igual, sin "
                "esperar una etiqueta 'Concepto' explicita. Cadena vacia solo si no "
                "aparece ninguna referencia de este tipo en el documento."
            ),
        },
        "items": {
            "type": "array",
...
_EXTRACTION_PROMPT = (
    ...
    "una descripcion general y la cantidad total. Busca tambien una "
    "referencia a otro documento (tipico en guias de traslado, donde se "
    "referencia la factura de origen del movimiento) y transcribila en "
    "concepto: puede estar en un campo con titulo 'Concepto' u "
    "'Observaciones', PERO en muchas guias reales no tiene ninguna etiqueta "
    "-- aparece como un codigo suelto tipo-numero (ej. 'FEI-12345') debajo "
    "del NIT, junto al nombre de la persona que transporta la mercaderia. "
    "Revisa esa zona del documento aunque no diga 'Concepto' en ningun "
    "lado. Si no encontras ninguna referencia asi, usa cadena vacia. Para "
    "tipo e indicativo_numero asigna un score de confianza entre 0 y 1 segun que "
