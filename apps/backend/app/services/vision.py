    ...
    "properties": {
        ...
        "concepto": {
            ...
            "description": (
                ...
                "tipicamente mas abajo en el documento, despues del titulo, el "
                "nombre del dueno/empresa, y el NIT, en ese orden -- usa esa posicion "
                "para ubicarlo. El codigo aparece DOS VECES seguidas, en dos renglones "
                "consecutivos: primero el renglon 'Concepto' (el codigo al final de "
                "ese renglon), e inmediatamente abajo un renglon 'Transporta' con el "
                "nombre de la persona y el codigo repetido otra vez al final, ej. "
                "'Concepto: ... FEI-152754' seguido de 'Transporta: NELSON LEON "
                "FEI-152754'. Revisa ambos renglones -- si uno esta poco legible, el "
                "otro trae el mismo dato. Transcribi en concepto el texto completo de "
                "ambos renglones (no solo el codigo aislado). Cadena vacia si "
...
_EXTRACTION_PROMPT = (
    ...
    "cual en concepto. El codigo aparece DOS VECES seguidas, en dos "
    "renglones consecutivos: primero el renglon 'Concepto' (el codigo al "
    "final de ese renglon), e inmediatamente abajo un renglon 'Transporta' "
    "con el nombre de la persona y el codigo repetido otra vez al final, "
    "ej. 'Concepto: ... FEI-152754' seguido de 'Transporta: NELSON LEON "
    "FEI-152754'. Revisa ambos renglones -- si uno esta poco legible, el "
    "otro trae el mismo dato. Transcribi el texto completo de ambos "
    "renglones en concepto, no solo el codigo aislado. Ese bloque esta "
    "tipicamente mas abajo en el documento, en este orden: titulo, nombre "
    "del dueno/empresa, NIT, y recien despues 'Concepto'/'Transporta' -- "
    "usa esa posicion para ubicarlo si el "
