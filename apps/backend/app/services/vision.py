    ...
    "properties": {
        ...
        "concepto": {
            ...
            "description": (
                ...
                "que mezcla el nombre de quien transporta con la referencia a la "
                "factura, ej. 'Transporta Luis Perez y factura FEI-12345' -- leela "
                "completa y transcribila tal cual, no busques solo el codigo aislado. "
                "Cadena vacia si el documento no tiene campo 'Concepto'."
            ),
        },
        "items": {
            "type": "array",
...
_EXTRACTION_PROMPT = (
    ...
    "una frase que mezcla el nombre de quien transporta la mercaderia con "
    "la referencia a la factura, por ejemplo 'Transporta Luis Perez y "
    "factura FEI-12345' -- transcribi la frase completa, no busques solo "
    "el codigo aislado. Ese campo esta tipicamente mas abajo en el "
    "documento, en este orden: titulo, nombre del dueno/empresa, NIT, y "
    "recien despues 'Concepto' -- usa esa posicion para ubicarlo si el "
