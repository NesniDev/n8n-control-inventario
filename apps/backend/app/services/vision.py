    ...
    "properties": {
        ...
        "concepto": {
            ...
            "description": (
                ...
                "para ubicarlo. Cadena vacia si el documento no tiene campo "
                "'Concepto'."
            ),
        },
        "items": {
...
_EXTRACTION_PROMPT = (
    ...
    "indicativo/numero propio de la guia, ej. si la guia es 'TB-500' el "
    "concepto puede decir algo como 'FEI-12345') y transcribilo completo y "
    "tal cual en concepto. Ese campo esta tipicamente mas abajo en el "
