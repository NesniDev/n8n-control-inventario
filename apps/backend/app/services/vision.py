    ...
    "properties": {
        ...
        "concepto": {
            ...
            "description": (
                ...
                "para ubicarlo. No siempre es un valor limpio: suele ser una frase "
                "corta que junta la palabra 'Transporta', el nombre de la persona, y "
                "el codigo pegados sin mas conectores, ej. 'TRANSPORTA NELSON LEON "
                "FEI-152754' -- leela completa y transcribila tal cual, no busques "
                "solo el codigo aislado. Ese mismo codigo suele repetirse tambien en "
                "la parte superior del documento -- si el campo 'Concepto' esta poco "
                "legible, revisa arriba por si aparece de nuevo ahi. Cadena vacia si "
...
_EXTRACTION_PROMPT = (
    ...
    "cual en concepto. Ese campo no siempre es un valor limpio: a veces es "
    "una frase corta que junta 'Transporta', el nombre de la persona, y el "
    "codigo pegados sin mas conectores, por ejemplo 'TRANSPORTA NELSON "
    "LEON FEI-152754' -- transcribi la frase completa, no busques solo el "
    "codigo aislado. Ese mismo codigo suele repetirse tambien en la parte "
    "superior del documento -- si el campo 'Concepto' esta poco legible, "
    "revisa arriba por si aparece de nuevo ahi. Ese campo esta tipicamente "
    "mas abajo en el documento, en este orden: titulo, nombre del "
    "dueno/empresa, NIT, y recien despues 'Concepto' -- usa esa posicion "
    "para ubicarlo si el "
